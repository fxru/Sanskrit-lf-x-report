...
\newfontface\devbfont{Annapurna SIL Bold}[Renderer=Graphite,Script=Devanagari,Language=Sanskrit]
\newfontface\devhmfont{Kohinoor Devanagari Medium}[Script=Devanagari,Language=Sanskrit]
\newfontface\devhbfont{Kohinoor Devanagari Bold}[Script=Devanagari,Language=Sanskrit]
